    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 bg-background/50 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <img 
            src="/lovable-uploads/adf6e327-d859-4ae4-b9ad-b8be9d8de902.png" 
            alt="BLOX AI Logo" 
            className="h-8 w-auto"
          />
          <span className="text-xl font-bold gradient-text">BLOX AI</span>
        </Link>
            ...
            <DialogContent className="sm:max-w-md">
              ...
              <div className="flex flex-col items-center gap-4 py-4">
                <p className="text-center">
                  Portfolios holding $BLOXAI will be granted Pro Terminal access in the near future. Check out{' '}
                  <a 
