        ...
        <section className="space-y-8">
          <div>
            <p className="text-gray-300 leading-relaxed">
              Welcome to the BLOX AI Pro Terminal, The "Pro Terminal," operated by the BLOX AI team ("we," "us," or "our"). By accessing or using the Pro Terminal, holding BLOX AI ($BLOXAI) tokens, or engaging with our related services (collectively, the "Services"), you agree to be bound by these Terms and Conditions (the "Terms"). If you do not agree to all of these Terms, you are not authorized to use the Services.
            </p>
            <p className="text-gray-300 leading-relaxed mt-4">
              These Terms apply to all users of the Pro Terminal, including those accessing through any holding of BLOX AI tokens and those interacting with the BLOX AI via the Pro Terminal or on external platforms such as Twitter (X) or Telegram.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">To access the Pro Terminal's guaranteed response service, you must hold a minimum of 100,000 BLOX AI ($BLOXAI) tokens. We reserve the right to verify token holdings to ensure compliance with this requirement.</p>
            <h3 className="text-xl font-bold mt-4 mb-2">1.2 No Guarantee of Response on Twitter (X) or Telegram</h3>
            <p className="text-gray-300 leading-relaxed">While you may interact with the BLOX AI on Twitter (X) or Telegram by mentioning or engaging with it, there is no guarantee of receiving a reply.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">Users agree to be respectful and courteous when interacting with the BLOX AI, other community members, and our team. Harassment, hate speech, or other forms of abusive behavior will not be tolerated.</p>
            <h3 className="text-xl font-bold mt-4 mb-2">3.2 Prohibited Conduct</h3>
            <p className="text-gray-300 leading-relaxed">You agree not to use the Pro Terminal or the BLOX AI to:</p>
            <ul className="list-disc list-inside text-gray-300 leading-relaxed mt-2">
              <li>Violate any applicable law, regulation, or third-party right;</li>
              <li>Transmit any malicious code, software, or data that may harm the Pro Terminal, the BLOX AI, or other users;</li>
              <li>Spread misleading or deceptive information with the intent to manipulate or confuse;</li>
              <li>Solicit personal or sensitive information from other users or the BLOX AI;</li>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">We reserve the right to modify these Terms at any time. Any changes will be effective immediately upon posting on the BLOX AI Pro Terminal's website. Your continued use of the Services after the posting of revised Terms constitutes your acceptance of those changes.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">These Terms, together with any referenced policies such as our Privacy Policy, constitute the entire agreement between you and us regarding the use of the Pro Terminal and the BLOX AI and supersede any prior agreements or understandings.</p>
          </div>
          <div>
      ...
      <footer className="bg-black text-white py-8 px-4 sm:px-8 mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center items-center">
            <p className="text-sm text-gray-400">© 2025 BLOX AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
