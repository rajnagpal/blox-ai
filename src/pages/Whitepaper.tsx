  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-white">
      ...
      <main className="flex-grow py-32 px-4 sm:px-8 max-w-4xl mx-auto w-full">
        <h1 className="text-4xl sm:text-5xl font-bold pb-2 leading-normal gradient-text mb-12">BLOX AI Whitepaper</h1>
        <section className="space-y-8">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 gradient-text">Introduction</h2>
            <p className="text-gray-300 leading-relaxed">
              The BLOX AI (token: $BLOXAI) is a next-generation platform designed to empower users in the crypto and trading space through intelligent automation. At its core, BLOX AI aims to leverage artificial intelligence to optimize portfolio management, provide actionable insights, and streamline the user experience through a suite of specialized AI agents.
            </p>
          </div>
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 gradient-text">Tokenomics</h2>
            <p className="text-gray-300 leading-relaxed">
              The $BLOXAI token is the native cryptocurrency powering the BLOX AI ecosystem. It provides utility for accessing premium features and incentivizes community participation.
            </p>
            <h3 className="text-xl font-bold mt-4 mb-2">Token Distribution</h3>
            <p className="text-gray-300 leading-relaxed">Total Supply: 1,000,000,000 $BLOXAI</p>
          ...
          <div className="glass-card p-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Our mission is to democratize access to advanced trading tools and insights by utilizing cutting-edge AI technology. By combining automation with human oversight, BLOX AI delivers smart, efficient, and personalized solutions to its users, fostering financial growth and accessibility.
            </p>
          </div>
          <div className="glass-card p-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              AI agents are the core product of the BLOX AI Agent ecosystem. These agents provide services such as news aggregation, opinion sharing, and portfolio optimization.
            </p>
          ...
          <div className="glass-card p-6">
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed">
              <li>Launch BLOX AI Agent, the AI Trader automated bot on X (formerly Twitter).</li>
              <li>Finalize development of features, including news aggregation powered by advanced AI.</li>
              <li>Launch $BLOXAI, the native cryptocurrency powering the BLOX AI Agent ecosystem.</li>
            </ul>
            <h3 className="text-xl font-bold mt-4 mb-2">Q1 2025 (Current Phase)</h3>
            <ul className="list-disc list-inside text-gray-300 leading-relaxed">
              <li>Further expand the BLOX AI Agent bot's capabilities on Twitter to include advanced features such as sentiment analysis and dynamic market insights.</li>
              <li>Release the initial version of our professional Terminal for $BLOXAI token holders with advanced wallet analytics, curated news feeds, and premium analysis tools.</li>
            </ul>
          ...
          <div className="glass-card p-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              BLOX AI represents a unique fusion of artificial intelligence and blockchain technology. By offering a robust ecosystem powered by $BLOXAI, we aim to redefine the trading experience for crypto enthusiasts worldwide. With a clear roadmap and sustainable tokenomics, we are confident in delivering long-term value to our community.
            </p>
          </div>
        </section>
      </main>
